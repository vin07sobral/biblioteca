    ...
    <form name="formGrupo" method='post'>
        <fieldset><legend><i class="glyphicon glyphicon-plus text-primary"></i> Novo Registro</legend>
            <table class='table'>
                ...
                <tr>
                    <td>Nome</td>
                    <td><input type='text' name='nome' class='form-control' required autofocus placeholder="Nome da editora" maxlength="50"></td>
                </tr>
                ...
                <tr>
                    <td colspan="2">
                        ...
                        <a href="lista-editora.php" class="btn btn-large btn-danger"><i class="glyphicon glyphicon-remove-sign"></i> &nbsp; Cancelar</a>
                    </td>
                </tr>
